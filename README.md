...
Three systems were simulated, each consisting of a POPC lipid bilayer with S₈ molecules, GSH (Glutathione) molecules, or both. 
...
PMFs for S₈ and GSH were calculated using umbrella sampling MD simulations to identify favorable positions across the POPC lipid bilayer.
