...
Nmol=3 # number of molecules to insert
...
gmx editconf -f s8.gro -o s8_box.gro -d 0 -bt cubic -center 0 0 0
...
do 
	...
	do
        ...
        gmx insert-molecules -ci s8_box.gro -ip initial-positions.dat -o $replicate-$rep.pdb -box ${Box[*]}
...
### gmx make_ndx -f POPC-A-1.gro -n index.ndx -o index.ndx
### name 3 MEMB
### 2 | 4 | 5 | 6
### name 7 NON-MEMB
